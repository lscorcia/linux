...
#include "pinctrl-mtk-mt8167-paris.h"
#include "pinctrl-mtk-mt8516-paris.h"
...
static const struct mtk_pin_field_calc mt8516_pin_drv_range[] = {
	PINS_FIELD16(0, 4, 0xd00, 0x10, 1, 2),
	PINS_FIELD16(5, 10, 0xd00, 0x10, 5, 2),
	PINS_FIELD16(11, 13, 0xd00, 0x10, 9, 2),
	PINS_FIELD16(14, 17, 0xd00, 0x10, 12, 3),
	PINS_FIELD16(18, 20, 0xd10, 0x10, 1, 2),
	PINS_FIELD16(21, 23, 0xd00, 0x10, 12, 3),
	PINS_FIELD16(24, 25, 0xd00, 0x10, 9, 2),
	PINS_FIELD16(26, 30, 0xd10, 0x10, 5, 2),
	PINS_FIELD16(31, 33, 0xd10, 0x10, 9, 2),
	PINS_FIELD16(34, 35, 0xd10, 0x10, 13, 2),
	PINS_FIELD16(36, 39, 0xd20, 0x10, 1, 2),
	PIN_FIELD16(40, 40, 0xd20, 0x10, 5, 2),
	PINS_FIELD16(41, 43, 0xd20, 0x10, 9, 2),
	PINS_FIELD16(44, 47, 0xd20, 0x10, 13, 2),
	PINS_FIELD16(48, 51, 0xd30, 0x10, 1, 2),

	PIN_FIELD16(54, 54, 0xd30, 0x10, 9, 2),
	PINS_FIELD16(55, 57, 0xd30, 0x10, 13, 2),

	PINS_FIELD16(62, 67, 0xd40, 0x10, 9, 2),
	PIN_FIELD16(68, 68, 0xd40, 0x10, 12, 3),
	PIN_FIELD16(69, 69, 0xd50, 0x10, 0, 3),
	PINS_FIELD16(70, 73, 0xd50, 0x10, 4, 3),

	PINS_FIELD16(100, 103, 0xd50, 0x10, 8, 2),
	PIN_FIELD16(104, 104, 0xd50, 0x10, 12, 3),
	PIN_FIELD16(105, 105, 0xd60, 0x10, 0, 3),
	PINS_FIELD16(106, 109, 0xd60, 0x10, 4, 3),
	PINS_FIELD16(110, 113, 0xd70, 0x10, 0, 3),
	PIN_FIELD16(114, 114, 0xd70, 0x10, 4, 3),
	PIN_FIELD16(115, 115, 0xd60, 0x10, 12, 3),
	PIN_FIELD16(116, 116, 0xd60, 0x10, 8, 3),
	PINS_FIELD16(117, 120, 0xd70, 0x10, 0, 3),
};
...
static const struct mtk_pin_field_calc mt8516_pin_sr_range[] = {
	...
	PINS_FIELD16(48, 51, 0xd30, 0x10, 3, 1),

	PIN_FIELD16(54, 54, 0xd30, 0x10, 11, 1),
	PINS_FIELD16(55, 57, 0xd30, 0x10, 15, 1),
...
static const struct of_device_id mt8516_pinctrl_of_match[] = {
	{ .compatible = "mediatek,mt8167-pinctrl-paris", .data = &mt8167_pinctrl_data },
	{ .compatible = "mediatek,mt8516-pinctrl-paris", .data = &mt8516_pinctrl_data },
	{}
};
...
static struct platform_driver mt8516_pinctrl_driver = {
	.driver = {
		.name = "mediatek-mt8516-pinctrl-paris",
