...
#define MT6392_BUCK(match, vreg, min, max, step, volt_ranges, enreg,	\
		vosel_reg, vosel_mask, voselon_reg, vosel_ctrl,		\
...
#define MT6392_LDO(match, vreg, ldo_volt_table, enreg, enbit, vosel_reg,\
...
#define MT6392_LDO_LINEAR(match, vreg, min, max, step, volt_ranges,	\
		enreg, enbit, vosel_reg, vosel_mask, _modeset_reg,	\
